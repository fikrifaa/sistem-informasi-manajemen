...
<body>
  ...
  <section id="contact">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-1 col-md-10 col-sm-12" style="margin-top: -20 px; margin-bottom: 50px;">
            ...
            <div class="table-responsive">
              <table id="laporan" class="table table-bordered">
                ...
                <tbody>
                  ...
                  $result = mysqli_query(
                    $connect,
                    "SELECT p.nik, DATE(p.tgl_pengaduan), p.isi_laporan, t.tgl_tanggapan, t.tanggapan, t.id_petugas FROM pengaduan AS p INNER JOIN tanggapan AS t ON p.id_pengaduan=t.id_pengaduan WHERE p.nik=$nik"
                  );
                  ...
                  ?>
                    ...
                    <tr>
                      <td colspan="11" class="text-center">
                        <h3>Mohon maaf belum ada tanggapan untuk laporan Anda.</h3>
                      </td>
                    </tr>
                  <?php
                  }
