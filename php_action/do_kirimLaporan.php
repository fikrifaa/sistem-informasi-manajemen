...
if (isset($_POST['btnMessages'])) {
 ...
 $sqlMessage = "INSERT INTO pengaduan(id_pengaduan, tgl_pengaduan, nik, kategori, isi_laporan, foto, status)
                 VALUES(NULL, CURRENT_TIMESTAMP, '$nikPengaduan', '$kategori', '$isi_laporan', '$filename', '0')";
