...
<div class="content-wrapper">
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <button data-toggle="modal" data-target="#hapusPetugas"
                      data-id_petugas="<?= $row[0] ?>"
                      data-nama_petugas="<?= $row[1] ?>"
  ...
  <!--modal hapus-->
    <div class="modal fade" id="hapusPetugas" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form class="form-horizontal" action="petugas.php" method="post">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fa fa-pencil-square-o"></i>Hapus Petugas</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-outline-dark" name="hapusPetugas" autocomplete="off">Delete</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <script type="text/javascript">
    ...
    function formDelete(item) {
      ...
      // mengisi ke form
      $('#hapusPetugas #id_petugas').val(id_petugas);
      $('#hapusPetugas #nama_petugas').val(nama_petugas);
    }
  </script>
