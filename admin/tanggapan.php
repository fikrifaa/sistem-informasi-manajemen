...
$query = mysqli_query(
  $connect,
  "SELECT p.id_pengaduan, p.tgl_pengaduan,m.nama, p.isi_laporan, p.foto, p.status, t.id_tanggapan, t.tgl_tanggapan, t.tanggapan, pe.nama_petugas 
FROM pengaduan AS p LEFT JOIN tanggapan AS t ON p.id_pengaduan = t.id_pengaduan 
LEFT JOIN petugas AS pe ON t.id_petugas = pe.id_petugas LEFT JOIN masyarakat AS m ON p.nik = m.nik WHERE p.id_pengaduan=$id_pengaduan"
);
        ...
        <div class="col-sm-6 col-md-7 col-lg-10 mx-auto">
          <div class="card border-0 shadow rounded-3 my-5">
            <div class="card-body p-4 p-sm-5">
              ...
              <div class="float d-flex justify-content-between" style="padding-bottom:20px;">
