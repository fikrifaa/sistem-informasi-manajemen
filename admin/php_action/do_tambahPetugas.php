...
if (isset($_POST['tambahPetugas'])) {
  ...
  if ($password === $confirm_password) {
    ...
    if (mysqli_num_rows($checkusername) > 0) {
      ...
      echo "<script>window.alert('id_petugas sudah sudah terdaftar');
      window.location.href='petugas.php';</script>";
    } else {
      $result = mysqli_query($connect, "INSERT INTO petugas (id_petugas, nama_petugas, username, password, telp, level) VALUES('$id_petugas', '$nama_petugas', '$username', MD5('$password'), '$telp', '$level')");
